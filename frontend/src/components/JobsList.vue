...
<template>
  <div v-if="sortedJobs.length > 0" class="border-top-1 surface-border">
    <div class="p-2 font-bold surface-section border-bottom-1 surface-border text-900 text-sm">
      Jobs
    </div>
    <div class="overflow-auto" style="max-height: 12rem;">
      <div
      ...
      >
        ...
        <div class="flex-grow-1 min-w-0">
          ...
          <div v-if="job.status === 'processing'" class="text-xs text-500 mt-1">
